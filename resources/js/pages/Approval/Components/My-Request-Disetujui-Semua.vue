<template>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <ul class="timeline">
                    ...
                    <li class="completed">
                        <b>Menunggu Persetujuan (Senior ybs) pada {{ timeNow }}</b>
                        <br>
                        <small>Catatan : Oke lanjut !</small>
                    </li>
                </ul>
    ...
    <button class="btn btn-danger"><img src="/assets/media/logos/dl-pdf.png" alt="">&nbsp;&nbsp;Download PDF</button>
    <button class="btn btn-success" style="margin-left: 10px;"><img src="/assets/media/logos/dl-excel.png" alt="">&nbsp; Download Excel</button>
    </template>
