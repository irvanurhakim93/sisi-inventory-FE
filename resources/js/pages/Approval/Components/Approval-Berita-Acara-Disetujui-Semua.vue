<template>
            ...
            <div class="col-md-6 offset-md-3">
                <ul class="timeline">
                    <li class="completed">
                        ...
                        <br><small>Catatan : Oke lanjut !</small>
                    </li>
                    <li class="completed">
                        <b>Telah Disetujui Oleh (Senior ybs) pada {{ timeNow }}</b>
                        <br><small>Catatan : Oke lanjut !</small>
                    </li>
                </ul>
    ...
    <button class="btn btn" style="background-color: #EC221F; color: white;"><img src="/assets/media/logos/dl-pdf.png" alt="">Download PDF</button>
    <button class="btn btn" style="background-color: #14AE5C; color: white;"><img src="/assets/media/logos/dl-excel.png" alt="">Download Excel</button>
</template>
