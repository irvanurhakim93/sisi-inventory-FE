<template>
  <div class="card">
    ...
    <div>
      ...
      <div class="selected-image" v-for="(image, index) in selectedImages" :key="index">
        ...
        <button @click="removeSelectedImage(image)" class="btn btn-danger">Remove</button>
      </div>
    </div>
  </div>
  <div class="image-picker">
    ...
    <a href="/dokumentasi-penerimaan-barang/input/upload-dokumentasi" class="btn btn-light"> Gambar</a>
    &nbsp;&nbsp;
    <a href="" class="btn btn-dark">Simpan</a>
    <p v-if="selectedImages.length >= 3">Anda hanya bisa mengambil 3 gambar</p>
  </div>
</template>
